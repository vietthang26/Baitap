...
import Enity.Book;
import Enity.English;
import Enity.Literature;
import Enity.Science;
...
//		Inventory.addToInventory(new English("Táo Mỹ", 100, 5, 20));
//		Inventory.addToInventory(new English("Táo Tàu", 50, 1, 10));
//		Inventory.addToInventory(new Literature("Cam sành", 70, 7, 20));
//		Inventory.addToInventory(new Science("Chuối Mỹ", 50, 15, 1));
//		Inventory.addToInventory(new Science("Chuối Tiêu", 30, 10, 2));
...
//
//		System.out.println(Cart.addToCart(1, 3));
//
//		for (Book i : a) {
//			System.out.println(i.getId() + "   " + i.getNameTG() + "   " + i.getQuantity());
//		}
	}
}
