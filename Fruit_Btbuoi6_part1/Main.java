...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println("Bảng vitamin");
		List<Fruit> c = Inventory.getInstance();

		for (Fruit i : c) {
			System.out.print(i.getId()+" ");i.vitamin();
		}
		...
		if (luachon3 == 1) {
			...
			them = 1;
				...
				System.out.println("Nếu muốn thêm vào giỏ hàng hoặc thêm vào kho hãy nhập phím (1,2) nếu không hãy nhập phím 3: ");
				them = input.nextInt();
		}while (them!=3);
		System.out.println("Bảng chi tiết kho");
		...
		//Thành tiền
		System.out.println("Thành tiền: "+Cart.thanhTien());
	}
}
